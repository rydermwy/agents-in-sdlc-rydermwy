<script lang="ts">
     ...
     * 
     * @param {number | null} rating - The numeric rating (0-5) to display as stars, or null if not rated
     * @returns {string} A string representation using star characters (★ ½ ☆) or "Not yet rated" for null values
     */
